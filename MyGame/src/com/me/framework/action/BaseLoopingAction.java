package com.me.framework.action;
...
public abstract class BaseLoopingAction implements IActionPerformer {
	 ...
	 */
	public BaseLoopingAction(int numberOfRepeat, float elapseTimetoWork, float delayTime) {
		super();
		this.numberOfRepeat = numberOfRepeat;
		this.elapseTimetoWork = elapseTimetoWork;
	 ...
	 * @param elapseTime
	 */
	public BaseLoopingAction(float elapseTime, int numberOfRepeat, float delayTime) {
